...
exports.verifyResetToken = exports.sendResetPasswordEmail = exports.sendEmail = exports.generateResetToken = void 0;
...
var generateResetToken = exports.generateResetToken = function generateResetToken() {
  ...
  var hashedToken = _crypto["default"].createHash("sha256").update(resetToken).digest("hex");
  return {
...
// Verify reset token
var verifyResetToken = exports.verifyResetToken = function verifyResetToken(userToken, hashedTokenFromDB) {
  var hashedToken = _crypto["default"].createHash("sha256").update(userToken).digest("hex");
  return hashedToken === hashedTokenFromDB;
};
var sendResetPasswordEmail = exports.sendResetPasswordEmail = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(email, resetToken) {
    var resetUrl;
  ...
  return function sendResetPasswordEmail(_x2, _x3) {
